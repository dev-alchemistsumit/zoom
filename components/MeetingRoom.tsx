...
import { LayoutList, Route, Users } from 'lucide-react';
...
const MeetingRoom = () => {
  ...
  return (
        <section className='relative h-screenw-full overflow-hidden pt-4 text-white '>
...
<CallLayout/>
      ...
      <div className='fixed bottom-0 flex w-full items-center justify-center gap-5 flex-wrap'>
        {/* //callControls in the zoom meeting panel */}
